...
import app.notesr.files.viewer.OpenImageActivity;
import app.notesr.files.viewer.OpenTextFileActivity;
import app.notesr.files.viewer.OpenUnknownFileActivity;
import app.notesr.files.viewer.OpenVideoActivity;
